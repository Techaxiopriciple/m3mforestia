    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          {ECOSYSTEM.map((item, i) => {
            ...
            return (
              <div
                key={item.title}
                className="eco-item relative text-center px-6 py-8 lg:py-4"
              >
                {/* Vertical divider */}
                ...
                <h3 className="font-display text-lg sm:text-xl text-cream-50 tracking-[0.16em] leading-snug uppercase">
                  {item.title}
                </h3>

                <p className="mt-5 text-sm text-cream-100/80 leading-relaxed max-w-[230px] mx-auto">
                  {item.body}
                </p>
              </div>
            );
        ...
        <div className="max-w-3xl mx-auto text-center mt-14 sm:mt-16">
          <p className="text-sm sm:text-base text-cream-50/90 leading-relaxed">
        ...
        <div className="mt-12 sm:mt-14">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            {CONNECTIVITY.map((item) => (
              ...
              >
                <p className="text-sm sm:text-base text-cream-50">
                  {item.title}
                </p>
          ...
          <div className="flex justify-center mt-8">
            <a
              href="#enquiry"
              className="connectivity-item flex items-center justify-center bg-cream-50 text-forest-950 px-7 py-4 text-sm font-medium hover:bg-gold-400 transition-colors"
            >
              Enquire Now
            </a>
          </div>
